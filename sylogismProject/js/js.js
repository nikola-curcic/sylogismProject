...
$(document).ready(function () {
    ...
    function createScoreCard() {
        ...
        html += "<tr><th>Correct answer</th><th>Response</th>" +
                "<th>Response latency</th><th>Certainty rating</th>" +
                "<th>Total correct</th>" + "<th>Total incorect</th>"
                +"<th>Certainty average</th>" + "<th>Certainty rating for correct</th>" + "</tr>"; //Headers
        ...
        html += "<tr>" //table rows and data
            ...
            + "<td>" + certaintyAverage().toFixed(2) + "</td>" //
            + "<td>" + certaintyCorrect().toFixed(2) + "</td>" //these are loaded only once
            + "</tr>";
